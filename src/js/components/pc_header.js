...
class PCHeader extends React.Component {
  ...
  render() {
    ...
    : <Menu.Item key="register" class="register">
      <Icon type="exclamation-circle-o"/>注册/登录
    </Menu.Item>;
    return(
      <header>
        <Row>
          ...
          <Col span={16}>
            <Menu mode="horizontal" onClick={this.handleClick.bind(this)} selectedKeys={[this.state.current]}>
              ...
              <Menu.Item key="guonei">
                <Icon type="smile-o"/>国内
              </Menu.Item>
              <Menu.Item key="guoji">
                <Icon type="link" />国际
              </Menu.Item>
              <Menu.Item key="yule">
                <Icon type="apple-o"/>娱乐
              </Menu.Item>
              <Menu.Item key="tiyu">
                <Icon type="heart-o"/>体育
              </Menu.Item>
              <Menu.Item key="keji">
                <Icon type="aliwangwang-o"/>科技
              </Menu.Item>
              <Menu.Item key="shishang">
                <Icon type="customer-service" />时尚
              </Menu.Item>
              {userShow}
            </Menu>
